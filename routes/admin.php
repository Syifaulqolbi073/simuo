...
use App\Http\Controllers\Admin\ExamPackagePrintController;
...
Route::resource(
    'exam-schedules.packages',
    ExamPackageController::class
)->only([
    'index',
    'show',
    'destroy',
...
Route::post(
    'exam-schedules/{exam_schedule}/packages/generate',
    [ExamPackageController::class, 'generate']
)->name('exam-schedules.packages.generate');

Route::post(
    'exam-schedules/{exam_schedule}/packages/regenerate',
    [ExamPackageController::class, 'regenerate']
)->name('exam-schedules.packages.regenerate');
...
Route::get(
    'exam-schedules/{exam_schedule}/packages/{package}/print',
    [ExamPackagePrintController::class, 'print']
)->name('exam-schedules.packages.print');

Route::get(
    'exam-schedules/{exam_schedule}/packages/{package}/answer-key',
    [ExamPackagePrintController::class, 'answerKey']
)->name('exam-schedules.packages.answer-key');
